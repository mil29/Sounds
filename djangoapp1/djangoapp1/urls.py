...
urlpatterns = [
    ...
    path('users/friend-request/delete/<str:username>/', user_views.delete_friend_request, name='delete_friend_request'),
    path('users/friend/delete/<str:username>/', user_views.delete_friend, name='delete_friend'),
    path('edit-profile/', user_views.edit_profile, name='edit_profile'),
    path('my-profile/<slug:slug>/', user_views.my_profile, name='my_profile'),
